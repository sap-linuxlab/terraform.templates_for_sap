...
module "run_ansible_dry_run" {
  ...
  source = "github.com/sap-linuxlab/terraform.modules_for_sap//all/ansible_sap_s4hana_distributed_install_maintplan?ref=alpha"
...
module "run_account_init_module" {
  ...
  source = "github.com/sap-linuxlab/terraform.modules_for_sap//aws_ec2_instance/account_init?ref=alpha"
...
module "run_account_bootstrap_module" {
  ...
  source = "github.com/sap-linuxlab/terraform.modules_for_sap//aws_ec2_instance/account_bootstrap?ref=alpha"
...
module "run_bastion_inject_module" {
  ...
  source = "github.com/sap-linuxlab/terraform.modules_for_sap//aws_ec2_instance/bastion_inject?ref=alpha"
...
module "run_host_network_access_sap_module" {
  ...
  source = "github.com/sap-linuxlab/terraform.modules_for_sap//aws_ec2_instance/host_network_access_sap?ref=alpha"
...
module "run_host_network_access_sap_public_via_proxy_module" {
  ...
  source = "github.com/sap-linuxlab/terraform.modules_for_sap//aws_ec2_instance/host_network_access_sap_public_via_proxy?ref=alpha"
...
module "run_host_nfs_module" {
  ...
  source = "github.com/sap-linuxlab/terraform.modules_for_sap//aws_ec2_instance/host_nfs?ref=alpha"
...
module "run_host_provision_module" {
  ...
  source = "github.com/sap-linuxlab/terraform.modules_for_sap//aws_ec2_instance/host_provision?ref=alpha"
#  source = "github.com/sap-linuxlab/terraform.modules_for_sap//aws_ec2_instance/host_provision_nfs?ref=alpha"
  ...
  module_var_disable_ip_anti_spoofing = true
...
#  module_var_inventory_hana_primary   = module.run_host_provision_module["hana-p"].output_host_private_ip
#  module_var_inventory_nwas_ascs      = module.run_host_provision_module["nw-ascs"].output_host_private_ip
#  module_var_inventory_nwas_pas       = module.run_host_provision_module["nw-pas"].output_host_private_ip
#  module_var_inventory_nwas_aas       = join("\n", flatten([module.run_host_provision_module["nw-aas"].output_host_private_ip]))

  module_var_inventory_hana_primary   = "${module.run_host_provision_module["hana-p"].output_host_name} ansible_host=${module.run_host_provision_module["hana-p"].output_host_private_ip}"
  module_var_inventory_nwas_ascs      = "${module.run_host_provision_module["nw-ascs"].output_host_name} ansible_host=${module.run_host_provision_module["nw-ascs"].output_host_private_ip}"
  module_var_inventory_nwas_pas       = "${module.run_host_provision_module["nw-pas"].output_host_name} ansible_host=${module.run_host_provision_module["nw-pas"].output_host_private_ip}"
  module_var_inventory_nwas_aas       = "${module.run_host_provision_module["nw-aas"].output_host_name} ansible_host=${module.run_host_provision_module["nw-aas"].output_host_private_ip}"
