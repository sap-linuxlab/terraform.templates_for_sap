...
module "run_ansible_dry_run" {
  ...
  source = "github.com/sap-linuxlab/terraform.modules_for_sap//all/ansible_sap_ecc_hana_system_copy_hdb?ref=alpha"
  ...
  module_var_sap_hana_backup_directory        = ""
  module_var_sap_hana_backup_filename_prefix  = ""
  module_var_sap_swpm_backup_system_password  = ""
...
module "run_shell_download_obj_store_ibmcos" {
  ...
  source = "github.com/sap-linuxlab/terraform.modules_for_sap//all/shell_download_obj_store_ibmcos?ref=alpha"
