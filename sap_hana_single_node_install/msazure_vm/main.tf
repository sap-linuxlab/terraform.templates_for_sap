...
module "run_account_init_module" {
  ...
  source = "github.com/sap-linuxlab/terraform.modules_for_sap//msazure_vm/account_init"
...
module "run_account_bootstrap_module" {
  ...
  source = "github.com/sap-linuxlab/terraform.modules_for_sap//msazure_vm/account_bootstrap"
...
#
#  source = "github.com/sap-linuxlab/terraform.modules_for_sap//msazure_vm/account_iam"
#
#  module_var_az_resource_group_name = module.run_account_init_module.output_resource_group_name
#  module_var_resource_prefix = var.resource_prefix
#
...
module "run_bastion_inject_module" {
  ...
  source = "github.com/sap-linuxlab/terraform.modules_for_sap//msazure_vm/bastion_inject"
...
module "run_host_network_access_sap_module" {
  ...
  source = "github.com/sap-linuxlab/terraform.modules_for_sap//msazure_vm/host_network_access_sap"
...
module "run_host_provision_module" {
  ...
  source = "github.com/sap-linuxlab/terraform.modules_for_sap//msazure_vm/host_provision"
