...
variable "sap_anydb_install_sid" {
  description = "Ansible - SAP AnyDB install: System ID (e.g. DB2)"
}
...
variable "sap_swpm_template_selected" {
  description = "Ansible - Select template to use: sap_nwas_752_sp00_abap_ibmdb2_onehost, sap_nwas_750_sp00_abap_ibmdb2_onehost"
}
