...
module "run_ansible_dry_run" {
  ...
  source = "github.com/sap-linuxlab/terraform.modules_for_sap//all/ansible_sap_nwas_abap_sapmaxdb_install?ref=main"
...
}run_ansible_sap_nwas_abap_sapmaxdb_install" {
