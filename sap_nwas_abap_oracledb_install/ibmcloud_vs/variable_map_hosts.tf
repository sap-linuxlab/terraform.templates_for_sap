...
variable "map_host_specifications" {
  ...
  description = "Map of host specficiations for SAP NetWeaver with Oracle DB single node install"
  ...
  default = {
    ...
    small_32vcpu = {
      ...
      nw01c = {
        ...
        disk_volume_capacity_swap     = 136 // minimum 128GB swap for Oracle DB
        filesystem_swap               = "xfs"
