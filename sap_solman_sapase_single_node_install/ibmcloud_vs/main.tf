...
module "run_account_init_module" {
  ...
  # Use GitHub API to identify latest Terraform Modules for SAP release and use as HTTP ZIP for the Terraform Module Source and use sub-directory
  # (https://developer.hashicorp.com/terraform/language/modules/sources#http-urls)
  #source = "https://api.github.com/repos/sap-linuxlab/terraform.modules_for_sap/zipball//*/ibmcloud_vs/account_init?archive=zip"
#  source = "github.com/sap-linuxlab/terraform.modules_for_sap//ibmcloud_vs/account_init?ref=0.7.5"
