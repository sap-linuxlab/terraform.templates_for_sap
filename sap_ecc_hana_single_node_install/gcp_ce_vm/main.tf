...
module "run_ansible_dry_run" {
  ...
  source = "github.com/sap-linuxlab/terraform.modules_for_sap//all/ansible_sap_ecc_hana_install?ref=alpha"
...
module "run_ansible_sap_ecc_hana_install" {
  ...
  module_var_sap_swpm_sid = var.sap_ecc_hana_install_sid
