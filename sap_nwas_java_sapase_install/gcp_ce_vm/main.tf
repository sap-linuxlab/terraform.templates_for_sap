...
module "run_ansible_dry_run" {
  ...
  source = "github.com/sap-linuxlab/terraform.modules_for_sap//all/ansible_sap_nwas_java_sapase_install?ref=alpha"
...
module "run_ansible_sap_nwas_java_ibmdb2_install" {
  ...
  source = "github.com/sap-linuxlab/terraform.modules_for_sap//all/ansible_sap_nwas_java_ibmdb2_install?ref=alpha"
